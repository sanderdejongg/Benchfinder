...
- When a new session is started made sure you load all instructions below, rules take precedence over CLAUDE.md files. They must be 
strictly adhered to for the entirety of the session.
